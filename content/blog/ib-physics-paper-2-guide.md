...
Train yourself into a three-line habit for every calculation worth more than one mark:

1. **Equation** — write it in symbols exactly as it appears in the data booklet.
2. **Substitution** — put the numbers in, with units, before you touch your calculator.
3. **Answer** — the final value, rounded once, with the correct unit.
...
These are pure technique marks, and they are the ones that separate a 5 from a 7 because none of them require extra physics knowledge.
...
**"Show that" questions give you the answer** — for example, "show that the acceleration is approximately 9.8 m s⁻²." The trap is subtle: because the target value is printed, you must work to **more precision than the given figure** to prove you derived it rather than copied it. If the question says "≈ 9.8," carry your working to 9.81 or 9.813. Show every substitution; a "show that" with no working scores nothing even with the right final number.
...
Learn these cold; our [IB command terms explained](/blog/ib-command-terms-explained) guide lists them all.

## Graphs, gradients and uncertainties

Data-handling parts recur in almost every Paper 2, and they reward precision:
...
Not every mark is a calculation. An **explain** part wants the mechanism. Compare two answers to "explain why a satellite in a lower orbit moves faster":
...
None of these are about knowing less physics. They are the leaks that stop good candidates reaching a 7.
...
Paper 2 is won line by line. The equations are handed to you in the data booklet, so the marks come from *how* you answer: equation, substitution, answer with a unit; full working so ECF can rescue a slip; correct significant figures and direction; and command terms answered on their own terms. Drill the recurring calculation and graph questions until the layout is automatic, mark yourself the way an examiner would, and full marks on Paper 2 becomes a matter of method rather than luck.

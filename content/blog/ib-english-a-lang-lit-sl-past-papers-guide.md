...
Criterion A rewards **understanding and interpretation**; B rewards analysis of authorial choices; C rewards coherence; D rewards language. HL weightings differ slightly but skills align.
...
## Paper-specific tips
Avoid feature spotting — chain technique → meaning → writer purpose. Paper 2: balance both texts every paragraph, not two separate halves.

## Common pitfalls
Summarising plot; ignoring guiding question on Paper 1; no thesis on Paper 2; weak introduction that repeats the question.
...
Our free [English A: Language and Literature SL course](/ib/courses/english-a-lang-lit-sl) links every syllabus topic to lessons, flashcards, and practice tasks. Also see the [English A: Language and Literature HL course](/ib/courses/english-a-lang-lit-hl) if you sit the other level. Revise syllabus-by-syllabus with [topic practice](/ib/past-papers/english-a-lang-lit-sl#ib-topic-practice) — each point links to a lesson and criterion marking task.
...
## Bottom line
Treat [IB English A: Language and Literature SL past papers](/ib/past-papers/english-a-lang-lit-sl) as training for examiner thinking — not a trivia test. Cycle timed practice, honest band marking, and focused drills on your weakest criteria; that is how top candidates make a 7 predictable rather than lucky.

...
Every RQ that scores well shares four features:
...
Start with something you genuinely find fun — a sport, an instrument, cooking, cycling — then squeeze it down until only one variable moves. The funnel looks like this:

1. **Broad interest:** basketball.
2. **Physical phenomenon:** the ball bounces.
3. **Independent variable:** drop height.
4. **Dependent variable:** bounce height (or coefficient of restitution).
5. **RQ:** *How does drop height affect the coefficient of restitution of a basketball?*
...
Each idea below is phrased as a usable RQ with a note on why it works. Adapt the system to whatever you have to hand.
...
Examiners love a graph that becomes a straight line. If theory says the period of a pendulum is proportional to the square root of length, plotting period *squared* against length turns a curve into a line — and the **gradient** then hands you a physical constant (here, a value for *g*). A straight-line fit makes it obvious whether your data supports the theory and gives you a clean way to attach uncertainty. When you scout an RQ, ask early: *what can I plot to get a straight line, and what does its gradient mean?*
...
Once you have a rough idea, tighten it with a quick checklist:
...
One focused variable you change, one you measure, a specific system, and a known theoretical relationship to test — phrased so you can already picture the graph and attach uncertainties before you collect any data.
...
Pick something you like, funnel it to a single measurable variable, and choose the version that gives you a graph you can compare with theory — bonus points if it linearises into a straight line whose gradient means something. Keep the range wide, the uncertainties honest, and the equipment realistic. When your question is ready, work through the [IB Physics IA guide](/blog/ib-physics-ia-guide) for structure and criteria, then [get a draft marked](/mark) before your supervisor deadline.

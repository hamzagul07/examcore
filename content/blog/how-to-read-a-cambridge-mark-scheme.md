...
1. Read the **command words** (state, explain, evaluate, sketch).
2. Note **mark allocation** on the paper — that tells you depth expected.
3. Attempt the question **closed-book** for realistic timing.
...
Tools like [MarkScheme](/mark) help when you want the scheme applied to **your handwriting** — useful for checking whether your written working would earn M marks in maths or band evidence in essays.

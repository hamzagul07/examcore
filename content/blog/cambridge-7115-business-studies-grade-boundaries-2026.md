---
title: Cambridge 7115 Business Studies Grade Boundaries 2026 — June Thresholds Explained
...
Grade boundaries are the minimum **raw marks** Cambridge requires for each letter grade on each component of **7115 Business Studies**. They are not fixed percentages — your **overall** O-Level grade uses a weighted aggregate across the papers you entered, and each paper variant has its own row in the official PDF. Match your exact component codes from the statement of entry before comparing marks to any past session.

## How Cambridge sets 7115 boundaries

Cambridge sets **7115** thresholds **after** all scripts are marked so each grade means the same standard every year. Paper 2 case questions need the **business name**, quoted stimulus figures, and balanced pros/cons. When a paper is harder than the previous June series, raw cut-offs usually **fall** — comparable outcomes, not fixed quotas. Compare only to verified **7115** sessions ([wrong-session estimates](/insights)).
...
3. Compare component raw marks to June 2024/2023 in the [7115 calculator](/tools/grade-boundary-calculator/7115) until the verified June 2026 PDF loads.
...
Often yes — Cambridge adjusts so grades stay comparable.

### Where are past thresholds?

Cambridge PDFs + [7115 on MarkScheme](/subjects/7115).

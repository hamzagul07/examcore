...
category: editorial
featured: true
keywords: 9709 resit June 2026, Cambridge maths leak 2026, 9709 Paper 32, 9709 Paper 12 retake, assessed marks 9709, Cambridge maths replacement exam
...
Following premature sharing of **9709** papers online:

- Cambridge stated that compromised papers **cannot be used** to award final results
- Some candidates receive **assessed marks** calculated from other components (see [assessed marks guide](/blog/cambridge-assessed-marks-2026-explained))
...
Your **option codes** (M vs S routes) determine which Paper 4/5/6 combination you entered. Check your statement of entry.

Full syllabus revision hub: [9709 Mathematics past papers guide](/blog/cambridge-9709-a-level-mathematics-past-papers-guide).

## Replacement exam — revision focus by paper

### Paper 32 (Pure 3) — 8 June 2026 resit

High-yield Pure 3 topics that repeat across sessions:

| Topic | Exam habit to drill |
|-------|---------------------|
| Trigonometric identities & equations | Show every identity step — M marks die on skipped lines |
| Differentiation (implicit, parametric) | Chain rule errors — log in [error diary](/blog/fixing-silly-mistakes-cambridge-past-papers) |
...
1. Two timed **Paper 3** sessions from different years (90 min each)
2. Mark with [B1/M1/A1 rules](/blog/cambridge-a-level-maths-mark-scheme-b1-m1-a1) — no partial sympathy
3. Re-attempt only questions where method marks were lost
4. One full morning: mixed Pure 3 drill without notes
...
Cambridge extended administrative options for affected **9709/32** candidates, including:
...
If you are on **assessed marks** for Paper 52 rather than a resit:
...
Read the full method: [Cambridge assessed marks 2026](/blog/cambridge-assessed-marks-2026-explained).
...
Report suspicious material to your exams officer. See [exam leaks guide](/blog/cambridge-exam-paper-leaks-2026-what-students-should-know).

## Marking practice before the resit

Handwritten maths benefits enormously from a **second marking pass**:

1. Attempt a question closed book
2. Mark strictly against the official scheme
3. Upload to [MarkScheme](/mark) for line-by-line feedback on method marks

Photography tips: [how to photograph handwritten answers](/blog/photograph-handwritten-past-paper-answers).

## FAQ

### Is the replacement paper easier?

Cambridge designs replacement papers to the **same standard** as the original. Difficulty may feel different — that is normal. Grade thresholds adjust after marking.
...
- [Assessed marks explained](/blog/cambridge-assessed-marks-2026-explained)
- [9709 grade boundaries 2026](/blog/cambridge-9709-mathematics-grade-boundaries-2026)
- [Understanding ECF](/blog/understanding-error-carried-forward-ecf) — rescue marks after early slips
- [Exam dates 2026](/blog/cambridge-exam-dates-2026)

## Bottom line

The **9709 resit June 2026** is a second chance on a **new paper**, not a repeat of anything online. Use the next days for timed Pure papers, ruthless marking, and official materials only — that is how you turn a disrupted series into a grade universities still trust.

---
title: Cambridge O-Level Chemistry (5070) — past papers, mark schemes & how to mark
description: Complete guide to 5070 Chemistry O-Level: paper structure, how Cambridge mark schemes work, common mistakes, revision plan, and marking your answers with MarkScheme.
date: 2026-06-01
keywords: 5070 past papers, O-Level chemistry Cambridge, chemistry past papers, Cambridge O-Level
---

You did not choose Chemistry (5070) because you enjoy reading mark schemes for fun. You chose it because the grade matters — and past papers are where O-Level marks are actually won or lost.

Most students **finish** papers. Fewer students **mark** them properly. This guide is for the second group: you want Cambridge 5070 past papers, real mark scheme language, and a revision loop that moves your grade — not just your page count.

## Who this guide is for

- O-Level students sitting **5070** this series (or planning ahead)
...
- How **5070/XX** papers are labelled and which components you should practise
...
Past papers are published as **5070/XX** — **XX** is the component number for that session (e.g. Paper 1 vs Paper 4). Download the paper **and** the mark scheme for the **same session** from Cambridge International or your school portal. Mixing sessions is how students practise the right topic with the wrong marking rules.

---

## How Cambridge examines Chemistry
...
## Five mistakes that cost marks on 5070
...
### Where do I download 5070 past papers?
...
**5070 rewards precision against the mark scheme**, not vague knowledge. Learn examiner wording, mark honestly once per question, and fix one repeatable error at a time — that is how O-Level Chemistry scores move.

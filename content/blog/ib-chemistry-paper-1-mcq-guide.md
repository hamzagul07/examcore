...
Most avoidable Paper 1 errors are reading errors, not chemistry errors. The examiners write stems precisely, and a single qualifier can flip the correct answer. Slow down for a heartbeat and **underline the words that control the question**:
...
You rarely need to *know* the answer outright; you need to be the last option standing. Work by removing what cannot be true:
...
A chunk of Paper 1 is short calculations — moles, concentrations, empirical formulae, energetics, pH. The wrong options here are not random: they are engineered to be **exactly what you get if you make a common mistake**. That is the trap and, once you know it, the tell.
...
With roughly 30–40 questions in the section, aim for about **1 to 1.5 minutes per question** as a working average. Not every question deserves equal time:
...
Multiple choice rewards a specific kind of preparation, and it is not passive re-reading.
...
None of these are about knowing less chemistry. They are about discipline under the clock.
...
Paper 1 multiple choice rewards technique as much as knowledge. There is no negative marking, so **never leave a blank** and always guess after eliminating what you can. Read qualifiers like "NOT" and "LEAST" carefully, sanity-check calculation answers on units and order of magnitude, and refuse to be flattered by a distractor built from a common mistake. Pace yourself at around a minute a question, flag the hard ones and return, and fill every box before time runs out. Do that on top of timed, realistic practice, and Paper 1 becomes a section you control rather than one that controls you.

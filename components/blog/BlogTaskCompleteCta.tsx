...
export function BlogTaskCompleteCta() {
  return (
    <section
      className="ec-blog-task-cta my-10 rounded-xl border border-[var(--ec-brand)]/30 bg-[color-mix(in_srgb,var(--ec-brand)_8%,transparent)] p-6 sm:p-8"
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div>
          ...
          <Link
            href="/mark"
            className="ec-btn-primary mt-4 inline-flex min-h-[48px] text-sm"
          >

---
title: Cambridge A-Level Economics (9708) past papers
...
Most students **finish** papers. Fewer students **mark** them properly. This guide is for the second group: you want Cambridge 9708 past papers, real mark scheme language, and a revision loop that moves your grade — not just your page count.

## Who this guide is for

- A-Level students sitting **9708** this series (or planning ahead)
...
- How **9708/XX** papers are labelled and which components you should practise
- What **mixed (MCQ, data response, essay bands)** looks like in real examiner language
...
| **Level** | A-Level |
| **Syllabus code** | 9708 |
| **Typical marking** | mixed (MCQ, data response, essay bands) |

Past papers are published as **9708/XX** — **XX** is the component number for that session (e.g. Paper 1 vs Paper 4). Download the paper **and** the mark scheme for the **same session** from Cambridge International or your school portal. Mixing sessions is how students practise the right topic with the wrong marking rules.
...
## Five mistakes that cost marks on 9708
...
### Where do I download 9708 past papers?
...
**9708 rewards precision against the mark scheme**, not vague knowledge. Learn examiner wording, mark honestly once per question, and fix one repeatable error at a time — that is how A-Level Economics scores move.

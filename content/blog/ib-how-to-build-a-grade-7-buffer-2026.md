...
description: Stop gambling on grade boundaries — build a 5–10 mark raw-mark buffer in HL and SL subjects with IA marks, paper drills, and band-targeted practice.
date: 2026-07-06
updated: 2026-07-06
category: revision
featured: true
keywords: IB grade 7 buffer, IB grade boundaries 2026, how to get a 7 IB, IB raw marks strategy, IB HL grade 7
...
See [IB grade boundaries explained](/blog/ib-grade-boundaries-explained) for how boundaries are set — then stop refreshing prediction threads.

## The three-layer buffer model

### Layer 1 — Internal Assessment (IA)

Roughly **20–30%** of final marks in many subjects. Strong IA:
...
Use **last 2–3 May sessions** for your subject and level as a guide — not a guarantee.
...
Track **technique losses** separately — they are the cheapest buffer to buy back.
...
HL has more content and often an extra paper. Boundaries are set separately — difficulty is not directly comparable by percentage alone.
...
Predicted grades are for university apps; they do not change exam boundaries. See [predicted grades explained](/blog/ib-predicted-grades-explained).
...
Treat **IB grade boundaries 2026** as background noise. Maximize IA, mark honestly to band descriptors, and build a raw-mark cushion on the papers you control — that is how a 7 becomes predictable instead of lucky.

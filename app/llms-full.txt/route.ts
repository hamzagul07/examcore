...
export async function GET() {
  ...
  const lines = [
    ...
    `- ${base}/blog/ib-command-terms-explained`,
    ...
    '',
    '### Per-subject IB study guides — economics, chemistry, physics, biology, psychology, maths-aa, business-management (every URL is under "Blog articles" below):',
    `- "How to get a 7 in IB <subject>" (SL & HL), e.g. ${base}/blog/ib-chemistry-how-to-get-a-7`,
    `- "IB <subject> SL vs HL — which to take", e.g. ${base}/blog/ib-chemistry-sl-vs-hl`,
    `- "Is IB <subject> hard?" (honest difficulty), e.g. ${base}/blog/ib-chemistry-hard`,
    `- Exam paper technique, e.g. ${base}/blog/ib-economics-paper-1-guide, ${base}/blog/ib-psychology-erq-essay-guide, ${base}/blog/ib-chemistry-paper-2-guide`,
    `- New-syllabus explainers, e.g. ${base}/blog/ib-chemistry-2025-syllabus-changes, ${base}/blog/ib-business-management-2024-syllabus-changes`,
    '',
    '## Blog articles',

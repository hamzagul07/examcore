...
> **Key takeaway:** Pick objects first, then the prompt they illuminate — not the prompt TikTok said was "easy."
...
1. **Brainstorm 8–12 candidate objects** from your life, studies, or news — each must be **specific** (not "a book" but *your copy of a particular edition with a named annotation*)
2. Write **one sentence of real-world context** per object
3. Read all **35 prompts** slowly — shortlist 3–5 that your objects could genuinely support
4. Pick the prompt where all **three object links** are clearest and most distinct
...
Anchor in a [TOK optional theme](https://www.ibo.org/programmes/diploma-programme/curriculum/dp-core/theory-of-knowledge/) (Knowledge and technology, Politics, Religion, Indigenous societies, etc.) if you are stuck — it narrows object choice.

Full subject overview: [IB Theory of Knowledge](/ib/subjects/tok) · Free [TOK course](/ib/courses/tok).
...
Essay workflow: [IB TOK past papers & essay guide](/blog/ib-tok-past-papers-guide). Exhibition + strong essay + strong EE = maximum core points.

## Using MarkScheme for feedback

After drafting commentary:

1. Self-assess against the exhibition rubric bands
2. Highlight sentences that are **description only** — rewrite as knowledge analysis
3. Submit a section for [criterion-based TOK feedback](/mark?subject=ib-tok) before your final teacher submission

## FAQ

### Are the 35 prompts the same in May and November 2026?

Yes — the IA prompt list is stable across sessions within the current TOK guide cycle.
...
- [IB TOK essay & revision guide](/blog/ib-tok-past-papers-guide)
- [IB markbands explained](/blog/ib-markbands-explained)
- [Extended Essay complete guide](/blog/ib-extended-essay-complete-guide)
- [IB Diploma past papers hub](/blog/ib-diploma-past-papers-guide)

## Bottom line

The **TOK exhibition 2026** rewards students who connect **three real objects** to one **unchanged official prompt** with tight, analytical prose — not performance skills or leaked "easy prompts." Build your object shortlist this week, match the prompt that fits, and mark your own commentary like an examiner before you submit.

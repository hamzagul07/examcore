...
Because *command terms* set the task, misreading "evaluate" or "examine" as "describe" is fatal — study [IB command terms explained](/blog/ib-command-terms-explained) so *discuss*, *evaluate*, and *to what extent* each trigger the right response. The same skill is drilled in our guide on [hitting the top essay markbands](/blog/ib-how-to-hit-the-top-markbands-in-essays).
...
1. **LEARN** — take one syllabus point, study the processes, and add or refine a **located case study** with real figures. Use the free [Geography SL course](/ib/courses/geography-sl) or [HL course](/ib/courses/geography-hl) to work syllabus-by-syllabus.
2. **PRACTICE** — do a timed past question on that point: a Paper 1 extended response, a Paper 2 global-change part, or (HL) a Paper 3 essay. Plan the structure first, sketch any map, then write to time. Pull questions from the [SL](/ib/past-papers/geography-sl) and [HL](/ib/past-papers/geography-hl) past papers.
3. **GET-MARKED** — mark it against the band descriptors, then [get an answer marked](/mark?subject=ib-geography-hl) for a second opinion aligned to the criteria. Keep a mistake log of your top three recurring errors and drill those first next week.

Run this cycle across every theme, weighting the ones where your band marking is weakest, and start the [fieldwork IA](/blog/ib-geography-ia-guide) early — it is criterion-marked and represents accessible marks too many students leave to the last minute.
...
It is the main thing separating a 5 from a 7. Description reaches the middle bands; balanced evaluation with a reasoned judgement, backed by a located example, reaches the top. See [IB command terms explained](/blog/ib-command-terms-explained).

## Bottom line
A 7 in IB Geography is predictable, not lucky. Build a bank of named, located case studies with real data, drill your map, graph and statistics skills, and practise structuring extended responses as **process → case study → evaluation → judgement**. Mark honestly against the bands — especially the high-tariff evaluation questions — and, at HL, give Paper 3 (global interactions) its own dedicated preparation. Cycle LEARN → PRACTICE → GET-MARKED every week, drill your recurring errors, and start the fieldwork IA early. That is how top candidates turn a 7 from a hope into a habit.
</content>
</invoke>

...
## The maths factor
This is the heart of it. You do not need to be a mathematician, but you do need to be *comfortable* with maths: rearranging equations, working with standard form and significant figures, handling trigonometry and vectors, and reading graphs. At HL the maths steps up again, with more demanding algebra in topics like fields and induction.
...
Physics gives you more support than students realise:
...
Explore the full syllabus in the free [IB Physics SL course](/ib/courses/physics-sl) and [HL course](/ib/courses/physics-hl) to see exactly what is covered before deciding.

## SL vs HL — how much harder is HL?
HL is a clear step up, not a gentle extension. On top of the shared core, HL adds substantial content and heavier maths, including rigid body mechanics (rotational motion), thermodynamics, electromagnetic induction, special relativity, and quantum physics.

These are also some of the most abstract topics in the whole course, and the HL papers demand deeper multi-step reasoning and more confident algebra. If you are choosing between them, be honest about how much you enjoy the problem solving, not just the ideas — HL asks for a lot more of it. Our [IB Physics SL vs HL](/blog/ib-physics-sl-vs-hl) comparison breaks the differences down topic by topic.

## Is a 7 achievable?
Yes — a 7 is realistically achievable, and it comes down to method more than raw talent. There is no shortcut: the students who reach the top grades work through large numbers of exam-style problems, then mark their own answers honestly against the mark scheme to see exactly where marks were won or lost.

That honest self-marking is the part people skip. Reading a worked solution and nodding along is not the same as producing it under time pressure. When you mark yourself strictly, you find the specific steps — a dropped unit, a rearrangement slip, a missed uncertainty — that separate a 6 from a 7. For a full plan, see [how to get a 7 in IB Physics](/blog/ib-physics-how-to-get-a-7).

## Who tends to find it hard vs easy
**More likely to find it hard:**
- Students who dislike or avoid maths
- Those who prefer memorising to problem solving
- Anyone who struggles to keep track of multi-step working
...
1. **Fix your algebra first.** Every hour spent getting fluent at rearranging and substituting pays off across the whole course.
2. **Learn the data booklet.** Know what is in it and where, so you spend exam time solving, not searching.
3. **Practise by problem type.** Drill projectiles, circuits, waves, and energy in batches until the method is automatic.
4. **Always show full working.** Method marks are awarded even when the final answer is wrong — so lay out every step.
5. **Mark yourself honestly.** After each question, compare against the mark scheme and log the exact reason for any lost marks.
6. **Do timed past papers.** Build speed and stamina under real conditions, starting with the [SL past papers guide](/blog/ib-physics-sl-past-papers-guide).
...
## Bottom line
IB Physics is hard, but predictably so: the difficulty lives in the maths and the multi-step problem solving, not in an impossible mountain of facts. If you are comfortable with algebra — especially if you are taking HL Maths — much of the challenge dissolves into practice. Learn the data booklet, drill the repeating problem types, show full working, and mark yourself honestly against the criteria. Do that consistently and a 7 stops being a gamble and starts being the natural result of the work.

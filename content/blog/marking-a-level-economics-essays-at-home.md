...
1. **KAA (Knowledge, Application, Analysis)** — Is there a concept named correctly and applied to the prompt scenario?
2. **Development** — Is there more than one step of logic, or a list of three facts?
3. **Evaluation** — Is there a counterpoint, condition, or judgement — not “however” with nothing after it?
...
If you use [MarkScheme](/mark), upload a photo of your handwritten essay response — the useful output is *which band language you hit or missed*, not a motivational paragraph.

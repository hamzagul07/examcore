...
> = {
  ...
  '6-1-data-security': { Component: DataSecurityDiagram, meta: { caption: 'Threats, pharming DNS redirect, authentication, backup, and physical controls.', attribution: { source: 'MarkScheme animation', license: 'Proprietary' } } },

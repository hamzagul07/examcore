...
This post is about **choosing and phrasing the question**. For the write-up itself — criteria, structure, uncertainties and evaluation — see the full [IB Chemistry IA guide](/blog/ib-chemistry-ia-guide).
...
Four things separate a top-band question from one that quietly caps your marks:
...
Start from something you genuinely care about, then narrow relentlessly:

1. **Pick a context** — food, sport, the environment, cleaning products, your own diet.
2. **Find a measurable property** inside it — an enthalpy, a rate, a concentration, a voltage.
3. **Choose one variable to change** and check you can control the rest.
4. **Pressure-test feasibility** — do you have the reagents, the apparatus, and the time to run repeats safely?
...
Each of these is phrased as a usable RQ. Adapt the specifics to your lab.
...
Once you have a draft, tighten it:

1. **Add ranges and units** — "temperature" becomes "temperature from 20 °C to 70 °C in 10 °C steps."
2. **Name the system precisely** — which acid, which brand, which concentration.
3. **State how the DV is measured** — "by titration against DCPIP," "by gas volume over 120 s."
4. **Check the theory link** — write one sentence predicting the trend from chemistry. If you can't, the question is too thin.
5. **Do a mini pilot** — one rough run shows whether the effect is even detectable before you commit ten hours.
...
A single independent variable, a measurable quantitative dependent variable, controllable conditions, and a clear link to syllabus chemistry — phrased as "How does X affect Y of Z?" so the whole investigation has one clear focus.
...
The best IB Chemistry IA topic is the one you can **measure safely at school** with the equipment you have, that produces numbers to process and a trend you can explain with chemistry. Start from something you care about, narrow it to one IV and one DV, add ranges and units, and pressure-test it with a quick pilot. Get the question right and the rest of the IA follows — then take it into the full [IB Chemistry IA guide](/blog/ib-chemistry-ia-guide) and the wider [IB guides hub](/guides/ib) to build it out.

...
export const CONTENT_CLUSTERS: ContentCluster[] = [
  ...
  },
  {
    ...
    slugPatterns: [
      ...
      /^edexcel-ial-maths-marking/,
      /^edexcel-wma11/,
      /^edexcel-wph11/,
      /^edexcel-ial-physics-past-papers/,
      /^edexcel-ial-chemistry-marking/,
  ...
  },
  {
    ...
    slugPatterns: [
      ...
      /^edexcel-ial-maths-grade-boundaries/,
      /^cambridge-component-marks/,
      /^cambridge-may-june-.*-grade-thresholds/,
    ],
    explicitSlugs: ['edexcel-ial-maths-grade-boundaries-ums-2026'],
  },
  {
    id: 'command-words',

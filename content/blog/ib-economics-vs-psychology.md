...
You can preview the syllabus and question styles through our [IB Economics SL course](/ib/courses/economics-sl) and, for the quantitative Paper 3 side, [Economics HL](/ib/courses/economics-hl).

## What IB Psychology is really like

Psychology has **no maths** — there are no diagrams to draw and no calculations to perform. What it does have is a lot of **studies**. You learn named pieces of research (the aim, the procedure, the findings and the conclusion) and, crucially, you must **use** them as evidence to build and support arguments. Knowing a study exists is not enough; you have to deploy the right one at the right moment to back a claim.
...
So Psychology rewards a specific combination: a good memory for detail plus the discipline to write to a rubric, again and again. You can see how the criteria play out in practice in our [IB Psychology SL course](/ib/courses/psychology-sl), with the extra HL content covered in [Psychology HL](/ib/courses/psychology-hl).

## The maths-and-diagrams vs essays-and-studies decision

This is the cleanest way to choose. Ask yourself which sentence sounds more like you:
...
Neither is objectively "the easy option," and we will not quote invented grade statistics to pretend otherwise. They are hard in **different ways**.
...
In short: choose based on the **type** of difficulty that suits you, not a myth about which is lighter. For a deeper look, see [Is IB Economics hard?](/blog/ib-economics-hard) and [Is IB Psychology hard?](/blog/ib-psychology-hard).

## For university

This can be the deciding factor, so check it early.
...
1. **Try both.** Attempt one topic from each — draw an Economics diagram and evaluate it; write a short Psychology answer using a study — and notice which felt natural.
2. **Check your target degrees.** If economics/PPE/finance is likely, that often settles it toward Economics (plus HL Maths).
3. **Be honest about maths.** Comfortable with numbers → Economics is open to you. Want to avoid maths entirely → Psychology.
4. **Be honest about memory.** Willing to memorise and critique many studies → Psychology suits you.
5. **Balance your overall diploma.** Consider your other five subjects and workload before locking one in.
...
Neither is reliably easier — they are hard in different ways. Economics blends concepts, diagrams and (at HL) calculations; Psychology demands heavy memorisation plus disciplined critical writing. Pick the type of challenge that fits you.
...
Both subjects reward good essay writing, so that skill helps either way. The real fork is simpler: **numbers and diagrams (Economics) versus essays and studies with no maths (Psychology)**. Choose Economics if you like models, graphs and some quantitative work — especially if economics, PPE or finance is your likely destination. Choose Psychology if you would rather master and critique a large body of research without any maths. Sample both, check your university requirements, and pick the challenge that matches how you actually think.

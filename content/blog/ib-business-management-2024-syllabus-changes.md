...
The revision reorganised the content, sharpened the analytical focus, and threaded a set of concepts through the whole course. The table below gives the shape of it — treat it as a map, not a full spec.
...
The whole course now sits inside five units, and knowing which one a topic belongs to helps you organise revision and predict how questions are framed.

1. **Introduction to business management** — what a business is, why it exists, business objectives, stakeholders, and the external environment.
2. **Human resource management** — organisational structure, leadership and management, motivation, and industrial relations.
3. **Finance and accounts** — sources of finance, costs and revenues, break-even, final accounts, ratios, cash flow, and investment appraisal.
4. **Marketing** — the marketing mix, market research, segmentation, branding, and marketing strategy.
5. **Operations management** — production methods, quality, location, supply chain, and (for HL) research and development and management of change.

Each unit carries **HL-only extension content** on top of the shared SL/HL core. If you are on HL, treat those extensions as non-negotiable — they are exactly where HL-specific questions come from. For a fuller breakdown of the level difference, see [IB Business Management SL vs HL](/blog/ib-business-management-sl-vs-hl).
...
Assessment is built on three **assessment objectives**:
...
The restructure rewards a specific style of study rather than more memorisation.
...
For the full grade-7 playbook, see [how to get a 7 in IB Business Management](/blog/ib-business-management-how-to-get-a-7).

## How to study the new syllabus

A simple loop keeps you aligned with the five-unit structure:

1. **Learn one unit at a time.** Lock in the definitions, the toolkit models that belong to it, and any HL extensions.
2. **Practise applied answers.** Write in chains: *tool → case evidence → so what → limitation → judgment*. Do quantitative questions timed, with full working.
3. **Get marked.** Check your answers against the AO descriptors and fix your recurring gap — usually "didn't apply" or "didn't judge."

Practise on level-appropriate papers — see the [SL past papers guide](/blog/ib-business-management-sl-past-papers-guide) for structured exam practice.
...
HL and SL share the five-unit core, but HL adds extension content within the units and sits the extra Paper 3. See [IB Business Management SL vs HL](/blog/ib-business-management-sl-vs-hl) for the detail.

## Bottom line

The 2024 IB Business Management syllabus repackages the subject into **five units**, puts a named **business management toolkit** at its centre, and threads concepts like ethics and sustainability through the course — all still assessed on AO1, AO2, and AO3, with a pre-released Paper 1, an unseen Paper 2, and an extra HL Paper 3. The skill it rewards is unchanged: apply the right tool to a real business and finish with a supported judgment. For the exact timings and HL Paper 3 specifics, confirm against the official IB subject guide, then study unit by unit and [get your answers marked](/mark) to find your ceiling.

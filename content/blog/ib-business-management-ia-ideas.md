...
This post is about **choosing and framing the question** — the part students get stuck on. For how to structure the report, meet the criteria and avoid moderator traps, read the companion [IB Business Management IA guide](/blog/ib-business-management-ia-guide).

## How the IB Business Management IA works (in brief)

The IA is a research project on a **real business**, answering a **forward-looking research question** about a decision or problem it faces. You support your answer with relevant business **tools and theory** and with your own **primary research** (interviews, surveys) plus **secondary research** (accounts, articles, market data), then reach a reasoned recommendation in a written report.

SL and HL differ in the length and scope of the task and the depth of analysis expected — always check the current subject guide and your teacher's brief for word counts and requirements. The full process, criteria and pitfalls are covered in the [IA guide](/blog/ib-business-management-ia-guide); this article stays on the question itself.

## What makes a strong research question

Every high-scoring RQ shares five features:
...
The single most common reason IAs underperform is **no data access**. Before you commit to a question, confirm you can get information from the business itself.
...
Use these as **templates** — swap in your real business and adapt the decision. Each is paired with the tools it naturally invites.
...
Turn a rough idea into a top-band RQ with a few passes:

1. **Start from a decision, not a topic.** "Marketing at [café]" is a topic. "Should [café] launch a loyalty app?" is a decision.
2. **Name the business and the choice.** Specificity forces focus.
3. **Pick a forward-looking stem** — "Should…", "To what extent would…", "How could…".
4. **Check the tools fit.** List the two or three tools the question invites. If none fit cleanly, adjust the question.
5. **Confirm data access.** Can you get the primary data this question needs? If not, change the business or the decision.
6. **Pressure-test both sides.** If you can argue for *and* against and reach a recommendation, you have a strong RQ.
...
The whole IA lives or dies on the question. Pick a **real business you can research**, frame a **forward-looking decision** it genuinely faces, and choose a question that **invites the tools** you know and needs **primary data** to answer. Avoid backward-looking, broad or descriptive questions and any business you cannot get data on. Nail the RQ, then use the [IA guide](/blog/ib-business-management-ia-guide) for structure and criteria, the [SL](/ib/courses/business-management-sl) and [HL](/ib/courses/business-management-hl) courses for tool fluency, and [MarkScheme](/mark) to check your analysis before the deadline. More IB support lives in the [IB guides hub](/guides/ib).

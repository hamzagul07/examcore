...
Every body paragraph in a strong ERQ follows the same five-move shape — learn it once and you can write to it on any prompt:

1. **Point** — a claim that directly answers the question.
2. **Study explained** — the aim, procedure and key findings of a relevant study, in enough detail to count as real knowledge (criterion B).
3. **Use it** — the crucial move: show *how* the study supports your point. "Because this study found X, we can argue Y about the question." This is criterion C.
4. **Critical thinking** — evaluate the evidence: a methodological strength or limitation, a possible bias, an alternative explanation, or how far it generalizes. This is criterion D.
5. **Link back** — one sentence tying the paragraph to the exact wording of the question.
...
Criterion C is about **using** research, not listing it. The question is not "do you know some studies?" but "does each study earn its place by advancing your answer?" The gap is easiest to see with a before-and-after.
...
Criterion D is where most 5s stall, and it fails in two predictable ways: the evaluation is bolted on at the end instead of woven through, and it is one-sided instead of balanced.
...
You typically get around 45 to 50 minutes per ERQ. Spend the first five planning and the essay writes itself faster.
...
You cannot improvise studies in an exam, so the work happens beforehand. For every study, keep a one-line record: researcher and year, aim, procedure, key finding, one strength, one limitation, and — the part most students skip — which questions it can answer. A single well-understood study often covers several prompts across an approach.

Aim for a compact bank you know deeply rather than a long list you half-remember, and pick studies that are *evaluable* — ones with an obvious methodological talking point or a contradicting study nearby, because those hand you criterion D for free. Our free [IB Psychology SL course](/ib/courses/psychology-sl) and [HL course](/ib/courses/psychology-hl) link every syllabus topic to lessons, flashcards and practice tasks, so the bank builds topic by topic.
...
No. "Discuss" wants a genuine both-sides treatment, "evaluate" wants a reasoned judgement, and "to what extent" wants an argument about how far the evidence supports a claim. Answer the wrong demand and criterion A suffers. See [how to hit the top markbands in essays](/blog/ib-how-to-hit-the-top-markbands-in-essays) and [IB markbands explained](/blog/ib-markbands-explained).

## Bottom line

The ERQ is not a memory test — it is an argument test with studies as evidence. Answer the exact question in your first sentence, build each paragraph on the five-move shape, use every study to prove a point rather than to fill space, and keep your critical thinking balanced and woven through. Win criteria C and D and the top band follows. For the bigger picture, read [how to get a 7 in IB Psychology](/blog/ib-psychology-how-to-get-a-7), browse the [IB guides hub](/guides/ib), and get your next essay [marked](/mark).

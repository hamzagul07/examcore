...
export function pricingSeoDescription(): string {
  ...
  return `Free to feel the first examiner stamp. Starter (${starter}/mo) for weekly practice, marked twice over. Scholar for whole papers and courses. Max (${max}/mo) — Vault, Cinema, priority marking, Sunday coach. Free courses forever.`
}

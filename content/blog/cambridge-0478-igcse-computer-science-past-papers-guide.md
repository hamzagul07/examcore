...
The IGCSE Computer Science qualification is assessed through two compulsory written papers, with no tiered entry. This means every candidate sits the same exams, graded on a scale from A* to G. It's crucial to prepare thoroughly for both components as they test different but complementary skill sets.
...
Focus on quality over quantity. It is far more effective to complete 4–6 past papers thoroughly—timing, marking, and reviewing each one in detail—than to rush through a dozen. The goal is to use them to find and fix your knowledge gaps. Our [IGCSE past papers overview](/blog/cambridge-igcse-past-papers-guide) offers more general advice on this.

## Bottom line
Success in Cambridge IGCSE Computer Science (0478) is not about memorising code; it's about building a solid theoretical foundation for Paper 1 and developing rigorous problem-solving skills for Paper 2. The most effective way to prepare is by engaging in a cycle of timed practice with past papers, strict self-assessment against the mark scheme, and targeted revision of your specific weaknesses.

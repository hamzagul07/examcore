...
- **Question type frequency** (set-text, thematic essay, synoptic)  
...
Even with different set texts, these **angles** recur:

| Theme | Typical command words | Band trap |
|-------|----------------------|-----------|
| Significance of an event/text | Explain, Assess | Description without **why it matters** |
| Competing interpretations | Discuss, Evaluate | One school only; no rebuttal |
| Ethics & law in practice | Discuss | General morality without syllabus framing |
| Role of revelation | Explain | Secular tone; no textual anchor |
| Unity vs diversity | To what extent | Slogans instead of evidence |
| Contemporary application | Evaluate | Opinion without scholarly or textual support |

Command-word drill: [9488 command words](/blog/cambridge-9488-islamic-studies-command-words-guide). Essay technique: [how to get an A* in 9488](/blog/how-to-get-an-a-star-in-cambridge-9488-islamic-studies).

## Essay habits that move bands

| Weak habit | Fix |
|------------|-----|
| Vague Qur'anic reference | **Surah:ayah** or named passage + linked point |
| Hadith without context | State **relevance** to the question, not volume |
| One-sided evaluation | Dedicated **counter** paragraph with rebuttal |
...
One precise reference per paragraph beats five vague mentions. Examiners reward **integration**.

...
Every candidate sits Papers 1 and 2; HL adds Paper 3. Crucially, **the GDC is allowed on every paper** — AI has no non-calculator paper at all.
...
Every AI mark scheme uses the official mathematics conventions. Learn what each label means and you stop throwing marks away:
...
This is where AI grades are made or lost. The calculator hands you *r*, a *p*-value or a probability in seconds; the marks come from choosing the right procedure and explaining what it means:
...
Modelling runs through the whole course: fit an exponential, trigonometric, logistic or piecewise model, use it to predict, then judge whether it is reasonable. Examiners reward stating assumptions, defining variables, and evaluating limitations.
...
- **Learn (2–3 sessions).** Take one syllabus subtopic and work the theory and worked examples in the [Maths AI SL course](/ib/courses/maths-ai-sl) or [HL course](/ib/courses/maths-ai-hl), then build recall with short flashcard bursts.
...
- **Get marked (honest).** Mark against the official scheme, awarding M/A/R marks line by line. Log every dropped mark by *cause* (no working, wrong mode, early rounding, missing interpretation) and drill your top three recurring errors next week. For a second opinion, [get an answer marked](/mark) for criterion-aligned feedback.
...
## Bottom line
A 7 in Maths AI is engineered, not gifted. Use the GDC well on every paper but still write the method, choose the right statistical test, keep full precision and round last, and always say what your numbers mean in context. Start your IA early, then cycle learn → timed practice → honest marking each week, and a 7 stops being luck and becomes the predictable result of examiner-shaped habits.

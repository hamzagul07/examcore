...
export const CONVERSATIONAL_QUERIES: ConversationalQuery[] = [
  ...
  { phrase: 'what online tool checks past paper marks', clusterId: 'resources-tools' },
  { phrase: 'best app to mark ib past papers', clusterId: 'ib' },
  { phrase: 'mark ib past paper online free', clusterId: 'ib' },
  { phrase: 'cambridge and ib study tool', clusterId: 'resources-tools' },
  { phrase: 'free courses for ib and a level', clusterId: 'resources-tools' },
  { phrase: 'is markscheme legit', clusterId: 'resources-tools' },
  { phrase: 'markscheme vs save my exams', clusterId: 'resources-tools' },
  { phrase: 'revision village alternative ib', clusterId: 'ib' },
  { phrase: 'online tool to check marks and study courses', clusterId: 'resources-tools' },
  { phrase: 'is markscheme free', clusterId: 'resources-tools' },
  { phrase: 'markscheme exam room', clusterId: 'resources-tools' },
  { phrase: 'markscheme press kit', clusterId: 'resources-tools' },
  { phrase: 'markscheme wikidata entity', clusterId: 'resources-tools' },
  { phrase: 'cambridge teacher past paper marking tool', clusterId: 'resources-tools' },
  ...
  { phrase: '0580 igcse maths grade boundaries 2026', clusterId: 'grade-boundaries' },
  { phrase: '0610 igcse biology grade boundaries 2026', clusterId: 'grade-boundaries' },
  { phrase: '0620 igcse chemistry grade boundaries 2026', clusterId: 'grade-boundaries' },
  { phrase: '0625 igcse physics grade boundaries 2026', clusterId: 'grade-boundaries' },
  { phrase: '0990 igcse english grade boundaries 2026', clusterId: 'grade-boundaries' },
  { phrase: '9231 further maths grade boundaries 2026', clusterId: 'grade-boundaries' },
  { phrase: '7707 o level accounting grade boundaries 2026', clusterId: 'grade-boundaries' },
  { phrase: '9696 geography grade boundaries 2026', clusterId: 'grade-boundaries' },
  { phrase: '5090 o level biology grade boundaries 2026', clusterId: 'grade-boundaries' },
  { phrase: 'when are igcse results 2026 cambridge', clusterId: 'grade-boundaries' },
  { phrase: 'cambridge a level results 11 august 2026', clusterId: 'grade-boundaries' },
  { phrase: 'igcse results 18 august not 11 august', clusterId: 'grade-boundaries' },
  { phrase: 'fake cambridge grade boundary spreadsheet', clusterId: 'grade-boundaries' },
  { phrase: 'how to convert raw marks to grade cambridge', clusterId: 'grade-boundaries' },

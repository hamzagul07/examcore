...
Both papers cover the same syllabus. The split is about *how* you may reach the answer, not *what* topics appear. (HL candidates also sit **Paper 3**, a pair of extended problem-solving investigations — a separate beast, not covered here.)

## How marks work on both papers

This is the single most valuable thing to understand, because it is identical across Paper 1 and Paper 2. Every AA mark scheme uses these labels:
...
On Paper 1 the exam is testing whether you can *do the mathematics*, not whether you can operate a calculator. So:
...
On Paper 2 the calculator does the heavy lifting — but a **bare answer can still miss the method mark**. The mark scheme wants to see the mathematics you set up before you keyed anything in.
...
Even on Paper 2, some parts are faster or safer by hand — and choosing well saves time.
...
Paper 1 and Paper 2 test the same syllabus under different rules: **no calculator and exact answers versus GDC and efficient computation**, both marked with M, A, R, AG and follow-through. So the winning technique is shared — show valid method on every question, keep full precision and round last on Paper 2, give exact forms and clean algebra on Paper 1, respect "show that" instructions, and manage the clock by marks. Do that and the method marks work *for* you on both papers, which is exactly how strong candidates make the difference between the two disappear.

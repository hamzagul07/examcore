---
title: Cambridge A-Level History (9489) — past papers, mark schemes & how to mark
description: Complete guide to 9489 History A-Level: paper structure, how Cambridge mark schemes work, common mistakes, revision plan, and marking your answers with MarkScheme.
date: 2026-06-01
keywords: 9489 past papers, A-Level history marking, history essay bands Cambridge, Cambridge history
---

You did not choose History (9489) because you enjoy reading mark schemes for fun. You chose it because the grade matters — and past papers are where A-Level marks are actually won or lost.

Most students **finish** papers. Fewer students **mark** them properly. This guide is for the second group: you want Cambridge 9489 past papers, real mark scheme language, and a revision loop that moves your grade — not just your page count.

## Who this guide is for

- A-Level students sitting **9489** this series (or planning ahead)
...
- How **9489/XX** papers are labelled and which components you should practise
- What **level-of-response (essay bands)** looks like in real examiner language
...
Past papers are published as **9489/XX** — **XX** is the component number for that session (e.g. Paper 1 vs Paper 4). Download the paper **and** the mark scheme for the **same session** from Cambridge International or your school portal. Mixing sessions is how students practise the right topic with the wrong marking rules.

---

## How Cambridge examines History
...
## Five mistakes that cost marks on 9489
...
### Where do I download 9489 past papers?
...
**9489 rewards precision against the mark scheme**, not vague knowledge. Learn examiner wording, mark honestly once per question, and fix one repeatable error at a time — that is how A-Level History scores move.

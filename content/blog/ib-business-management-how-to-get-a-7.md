...
Under the 2024 syllabus (first exams 2024), answers are judged against three **assessment objectives**, not a checklist of facts:
...
The **command term** tells you which AOs the examiner is looking for. Answer below the demand and you leave marks on the table; answer above it and you waste time. Match the term exactly.
...
Most students treat every question the same — a paragraph of theory regardless of the term. "Analyse" wants a developed chain; "evaluate" wants a weighed conclusion. See [IB command terms explained](/blog/ib-command-terms-explained) for the full list.
...
"Discuss," "evaluate," "recommend," and "to what extent" questions carry the most marks and are where students most often stall at one-sided analysis. Full AO3 needs two things.

1. **Balance** — argue both sides. A benefit *and* a drawback; short term *versus* long term; one stakeholder's gain *against* another's loss.
2. **A supported judgment** — do not stop at "it depends." State which side wins *for this business*, and justify it against a clear criterion: the company's objectives, its financial position, the timeframe, or the risk it can bear.
...
HL Paper 1 is an extended essay-style paper; SL is case-based structured questions. Practise with your own level's papers — see the [SL past papers guide](/blog/ib-business-management-sl-past-papers-guide) and the [HL past papers guide](/blog/ib-business-management-hl-past-papers-guide).

## The quantitative questions — method + accuracy marks

Paper 2 is unseen and includes a quantitative section. These questions are marked on **method and accuracy**, which is good news: showing correct working earns method marks even if your final number slips. Never write a bare figure.
...
Turn the syllabus into repeatable top-band answers with a loop across the five units (1 Introduction, 2 Human resource management, 3 Finance & accounts, 4 Marketing, 5 Operations):

1. **LEARN** — take one unit's tools at a time. Use the [SL course](/ib/courses/business-management-sl) or [HL course](/ib/courses/business-management-hl) to lock in definitions and worked calculations.
2. **PRACTICE** — write answers as chains: *tool → case evidence → so what → limitation → judgment*. Do quantitative questions timed, with full working.
3. **GET-MARKED** — self-mark honestly against the AO descriptors, then get a second opinion where it matters most: extended responses and evaluation. [Get an answer marked](/mark) for criterion feedback, and keep a mistake log — your recurring gap is usually "didn't apply" or "didn't judge."

Protect the IA too — it is criteria-marked coursework and free marks if started early. See the [IB Business Management IA guide](/blog/ib-business-management-ia-guide).
...
A 7 in IB Business Management is predictable, not lucky. Match the command term, apply every point to the named business, argue both sides, finish with a supported judgment, and show full working on the quantitative section. Run the LEARN → PRACTICE → GET-MARKED loop weekly, [get your answers marked](/mark) against the assessment objectives, and drill your weakest habit until application and evaluation become automatic.

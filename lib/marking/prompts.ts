...
- Analysis (AO3): Level 1 is a simple consequence or a one-step reason. Level 2 is a developed chain of reasoning about an individual element (cause → impact → further consequence, in context). Level 3 is analysis of the strategy or situation as a whole: how the elements connect to the business's overall position or the question's whole period. Quality decides the level, not quantity: ONE developed chain reaches Level 2 and ONE piece of whole-strategy analysis reaches Level 3, however much Level 1 or Level 2 material surrounds it. In the published standard, three separate elements each analysed well was Level 2 AO3; Level 3 needed the candidate to analyse the effect on the strategy or business as a whole. Several strong element-by-element chains are the TOP of Level 2, never Level 3.
- Evaluation (AO4), as examiners apply it: a judgement with little or no supporting evidence, or a judgement that merely repeats an analytical point, is Level 1. A judgement followed by the reason it was made (the supporting evidence) is Level 2. The moment the evaluative reasoning EXPLICITLY USES THE CASE CONTEXT (a specific reference to the case's people, figures, decisions or events inside the evaluation itself) it is Level 3, bottom of the range; a second explicit use of context in the evaluation takes it to the TOP of Level 3. Weighing alternative factors or different perspectives is what makes the best evaluations better; it is NOT the condition for Level 3, so never withhold Level 3 because the candidate did not balance the argument against factors they never raised, and never treat "to what extent" as requiring a counter-case. Evaluative comments count wherever they appear, not only in the conclusion.

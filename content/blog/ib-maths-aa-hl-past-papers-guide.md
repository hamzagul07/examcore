...
Alternate P1 and P2 practice. For Paper 3, work every available HL Paper 3 slowly with documented thinking.

## Paper-specific tips
Paper 1: exact forms and domain restrictions. Paper 2: note GDC inputs; round only at the end.

## Common pitfalls
Calculator on Paper 1; weak Paper 3 communication; IA dragging down strong exams.
...
Our free [Mathematics: Analysis and Approaches HL course](/ib/courses/maths-aa-hl) links every syllabus topic to lessons, flashcards, and practice tasks. Also see the [Mathematics: Analysis and Approaches SL course](/ib/courses/maths-aa-sl) if you sit the other level. Revise syllabus-by-syllabus with [topic practice](/ib/past-papers/maths-aa-hl#ib-topic-practice) — each point links to a lesson and criterion marking task.
...
### Course?
[Maths AA HL course](/ib/courses/maths-aa-hl) for topic-by-topic refresh.

## Bottom line
Treat [IB Mathematics: Analysis and Approaches HL past papers](/ib/past-papers/maths-aa-hl) as training for examiner thinking — not a trivia test. Cycle timed practice, honest band marking, and focused drills on your weakest criteria; that is how top candidates make a 7 predictable rather than lucky.

...
**No heavy maths.** If numbers and equations are your weak spot, History asks almost nothing of them. The challenge is entirely in reading, thinking and writing.
...
**Tends to find it easier:** students who enjoy building arguments and reading critically, who like history as a subject, who write clearly and structure answers well, and who read questions carefully for the command term. Strong essay-writers have a real edge.
...
An action plan that targets what actually gets marked:
...
- **Drill past questions early and often.** Plan the argument, write to time, then mark honestly against the bands and see where you dropped marks. Use the [SL past papers guide](/blog/ib-history-sl-past-papers-guide) and [HL past papers guide](/blog/ib-history-hl-past-papers-guide) to build a rhythm.
...
- **Start the IA early.** The [historical investigation](/blog/ib-history-ia-guide) is criterion-marked and represents accessible marks — do not leave it late.

For a deeper walkthrough see [how to get a 7 in IB History](/blog/ib-history-how-to-get-a-7), and work through the free [IB History SL course](/ib/courses/history-sl) or [HL course](/ib/courses/history-hl).
...
Yes. The challenge is well defined — argument, evidence, command-term focus and source technique — so disciplined timed practice with honest band-marking makes a 7 genuinely achievable. See [how to get a 7 in IB History](/blog/ib-history-how-to-get-a-7).

## Bottom line

IB History is not maths-hard or even memorisation-hard; it is writing-hard and analysis-hard. Arguing from evidence and writing to the markband are the real challenges — and both respond directly to timed essay practice and honest self-marking. There is no heavy calculation, the skills are learnable and transferable, and a 7 is genuinely achievable with disciplined work. Treat every essay as a chance to build an argument, mark yourself like an examiner, and the subject becomes far more manageable than its reputation suggests. If you are still choosing a level, read [IB History SL vs HL](/blog/ib-history-sl-vs-hl).

...
Build case study banks (pollution, conservation, energy). Practise essay plans that always include human + environmental lens and an evaluated solution.

## Paper-specific tips
Paper 1: cite data from the booklet. Paper 2: define key terms (carrying capacity, ecological footprint) precisely before developing.
...
Our free [Environmental Systems and Societies SL course](/ib/courses/environmental-systems-and-societies-sl) links every syllabus topic to lessons, flashcards, and practice tasks. Revise syllabus-by-syllabus with [topic practice](/ib/past-papers/environmental-systems-and-societies#ib-topic-practice) — each point links to a lesson and criterion marking task.

## Frequently asked questions

### ESS vs Biology SL?
ESS is interdisciplinary — less depth in pure bio, more on systems, policy, and ethics. Check university acceptance for your path.

...
If you want the full breakdown of criteria, structure and how the exploration is marked, read the companion [IB Maths IA guide](/blog/ib-maths-ia-guide) first — this article is deliberately about *choosing the topic*, not writing it up.

## What the IB Maths IA actually is

The IA is a **mathematical exploration**: an independent piece of writing (roughly 12–20 pages) that you research and produce over several months, worth 20% of your final Maths grade in both AA and AI. It is marked on criteria covering presentation, mathematical communication, **personal engagement**, reflection, and use of mathematics appropriate to your level.

The word "exploration" matters: this is not a homework sheet or a copied derivation — it is you investigating a question and reasoning your way through it. For how each criterion is scored and the structure examiners expect, see the [full IA guide](/blog/ib-maths-ia-guide).

## What makes an exploration strong

Four things separate a 7 from a 4, and none of them is "advanced maths":
...
The two courses reward different mathematics, so the *same interest* often points to different explorations.
...
Ideas are easy; focus is where marks are won. Try this:

1. **Name the interest** in one line ("I coach junior swimmers").
2. **Find the maths hiding in it** ("times drop with training — how fast, and does it plateau?").
3. **Write it as one answerable question** ("Can I model my squad's 50m times over a season, and predict the plateau?").
4. **Check you can get data or set up the maths yourself** — if not, narrow further.
...
- **Sanity-check the level** against your syllabus. The [Maths AA SL course](/ib/courses/maths-aa-sl) and [Maths AI SL course](/ib/courses/maths-ai-sl) lessons show exactly which techniques count as course-level for each route.
...
The best IB Maths IA ideas aren't found on a list — they're already in your life. Start from something you care about, find the mathematics inside it, and squeeze it down to one question you can actually answer at AA or AI level with your own working. Then read the [IB Maths IA guide](/blog/ib-maths-ia-guide) for structure and criteria, and [get an answer marked](/mark) before your supervisor deadline. Choose well and early, and the IA becomes the most controllable 20% of your Maths grade.

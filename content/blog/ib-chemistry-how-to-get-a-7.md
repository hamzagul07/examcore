...
HL adds AHL extensions on top of these, including entropy and Gibbs free energy (ΔG = ΔH − TΔS). Same concepts, greater depth and more demanding calculations. Browse the full topic breakdown in the free [IB Chemistry SL course](/ib/courses/chemistry-sl) or the [HL course](/ib/courses/chemistry-hl).

## The two papers and how each is marked

You cannot target a 7 without knowing how the marks are handed out. Paper 1 and Paper 2 reward different things.
...
These are the reliable mark-earners. Drill them until they are automatic, because they appear in some form on nearly every Paper 2.
...
Fix these and you remove the ceiling. None of them require new content — just discipline.

## A weekly LEARN → PRACTICE → GET-MARKED system

Sustainable improvement comes from a tight loop, not marathon sessions.

1. **LEARN** — pick one weak sub-topic (say, energetics) and refresh it properly using the [IB Chemistry SL](/ib/courses/chemistry-sl) or [HL course](/ib/courses/chemistry-hl). Understand the concept before drilling.
2. **PRACTICE** — do timed past-paper questions on that topic with a clock and the data booklet open. Work through the [IB Chemistry SL past papers guide](/blog/ib-chemistry-sl-past-papers-guide) or [HL past papers guide](/blog/ib-chemistry-hl-past-papers-guide) for a full paper-by-paper plan.
3. **GET-MARKED** — mark honestly against the criteria, then [get an answer marked](/mark) for a second opinion on your extended responses. Log every dropped mark by type (unit, sig fig, method, explanation) and drill your top three recurring errors before the next paper.

Run this loop weekly and start the [IB Chemistry IA](/blog/ib-chemistry-ia-guide) early — the internal assessment is criterion-marked and is free marks left on the table if rushed.
...
Fix the ceiling first: units, significant figures, and vague explanations. Then drill the core calculations, and start marking your extended answers honestly. Read [how to get a 7 in IB](/blog/ib-how-to-get-a-7-diploma) for the cross-subject habits.

## Bottom line

A 7 in IB Chemistry is engineered, not gifted. Know that Paper 2 is marked point-by-point on method and accuracy, exploit ECF by never abandoning a calculation, drill the reliable calculation mark-earners, navigate the data booklet on instinct, and always explain the reason behind the fact. Cycle LEARN → PRACTICE → GET-MARKED every week, mark yourself honestly, and the 7 stops being luck and becomes the predictable result of examiner-shaped practice.

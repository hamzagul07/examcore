---
title: How to Get a 7 in IB Physics (SL & HL) — Study Guide
description: The real path to a 7 in IB Physics: how Papers 1 and 2 are marked, earning method and accuracy marks with ECF
date: 2026-07-03
keywords: how to get a 7 in IB physics, IB physics grade 7, IB physics paper 2, IB physics method marks, IB physics revision, IB physics data booklet
category: revision
author: hassan
updated: 2026-07-03
...
Certain question types appear session after session. Drilling them to fluency is the highest-return revision you can do:
...
Every candidate gets the same data booklet with equations and constants. The difference is **fluency**. A 7 student knows roughly *where* each equation lives and does not waste two minutes hunting mid-exam, so practise every past question with the booklet open until flipping to the right section is automatic.
...
These are the leaks that stop strong students reaching a 7 — none of them are about knowing less physics:
...
Consistency beats cramming, and Paper 2 stamina depends on rest. Run a weekly loop:

1. **Learn** — pick one or two syllabus points you are weak on. Watch/read the lesson, then write the key equations and definitions from memory. Retrieval, not rereading.
2. **Practice** — do past-paper questions on that exact topic under gentle time pressure. Once a week, sit a full timed section to build exam pace.
3. **Get marked** — mark against the scheme honestly, awarding M and A marks separately so you see *where* you lost each one. Log every recurring error (a units slip, a radian-mode slip) and drill your top three next week.

Over a term this converts vague "I sort of get it" topics into reliable marks. For paper-by-paper strategy, see the [IB Physics SL past papers guide](/blog/ib-physics-sl-past-papers-guide) and the [HL past papers guide](/blog/ib-physics-hl-past-papers-guide). Don't neglect the [IB Physics IA guide](/blog/ib-physics-ia-guide) — the internal assessment is a criteria-marked scientific investigation and represents marks you can bank before exam season.
...
A 7 in IB Physics is earned point by point. The physics you need is finite and the equations are handed to you — the marks come from choosing the right method, showing working that unlocks method marks and ECF, and never leaking accuracy marks to units, sig figs, direction or calculator mode. Run the learn → practice → get-marked loop every week, mark yourself the way an examiner would, and a 7 stops being luck and starts being the predictable result of good technique.

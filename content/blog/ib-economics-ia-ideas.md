...
This post is about *choosing* topics. For how to actually write and structure each commentary against the rubric, see the [IB Economics IA guide](/blog/ib-economics-ia-guide).

## How the IB Economics IA works

The IA is a **portfolio of three commentaries**, each around **800 words**. Each one:
...
So "ideas" for the IA really means two things at once: a usable **article** and the **diagram/concept** you will attach to it. The full mechanics — rubric criteria, word count, key-term definitions, structure — are covered in the [IB Economics IA guide](/blog/ib-economics-ia-guide).

## What makes a good article

Before you commit to an article, check it against four filters:
...
Use these as **templates for the kind of story to look for**, not topics to copy. Find a current, specific version in the news.
...
Your three commentaries must span **microeconomics, macroeconomics, and the global economy** — one each. Plan the coverage before you fall in love with any single article:
...
Once you have a shortlist, tighten it:

1. **Name the diagram out loud.** If you hesitate, drop the article.
2. **Write the one-sentence question** the commentary will answer — e.g. "Will the UK's plastic tax reduce packaging waste?" A crisp question forces a crisp diagram.
3. **List two evaluation points** — a short-run/long-run split, a stakeholder who loses, or an assumption that might not hold. If you cannot find two, the article is too thin.
4. **Check the word budget.** At ~800 words, a narrow policy beats a sprawling one. Cut the article down to the single decision you will analyse.
...
As a rule, published **within about a year** of when you write the commentary. Check the current guidance your school follows, but the safe move is to use the most recent article you can find on the policy — recency is easy marks you should not throw away.
...
Good IA ideas are not clever topics — they are **specific, recent articles you can attach one clear diagram and real evaluation to**. Bank articles as you go, name the diagram before you commit, and deliberately cover all three sections. Then turn the shortlist into finished commentaries with the [IB Economics IA guide](/blog/ib-economics-ia-guide), and check a draft on [MarkScheme](/mark) before the deadline.

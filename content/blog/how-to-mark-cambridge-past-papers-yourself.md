...
- A notebook page titled with paper code + question (e.g. `9709/12 — Q4`)  
- Optional: [MarkScheme](/mark) for a second pass on handwriting  

---

## Why self-marking beats passive reading

Reading a model answer trains recognition. Self-marking trains **performance**:
...
1. Open the scheme **first**  
2. Cover your answer  
3. Award marks line by line — tick only what you would defend aloud  
4. Write **total + three lost-mark reasons** in your notebook  
...
Photograph the rewrite and upload to [MarkScheme](/mark) — especially if you labelled losses “silly”.
...
Read [B1 M1 A1 guide](/blog/cambridge-a-level-maths-mark-scheme-b1-m1-a1) if 9709 is your subject.

---

## Essays and longer responses

For Economics, History, Law, Sociology, and similar:

1. Print or split-screen **band descriptors**  
2. Highlight sentences that earn **application / analysis / evaluation**  
3. Ask: *Could an examiner point to this line in the band?*  
...
Keys are binary — your revision value is **why** each distractor traps you. Keep a running list:
...
See also: [revision schedule](/blog/cambridge-past-paper-revision-schedule) and [how many papers](/blog/how-many-cambridge-past-papers-before-exams).
...
Stricter than feels fair on the first pass. You can always re-read generously later — you cannot on exam day.
...
- [AI marking — honest guide](/blog/ai-marking-cambridge-past-papers-guide)

---

## Bottom line

Treat the mark scheme like the examiner’s checklist. Be strict once, fix one thing, then sit the next question. That loop — not another unmarked PDF — is what moves grades.

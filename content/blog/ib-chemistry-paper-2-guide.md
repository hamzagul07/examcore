...
Paper 2 is marked **analytically**, point by point, against a mark scheme. Two kinds of marks recur:
...
Units and significant figures are **explicitly assessed** on Paper 2, and they are the single most common source of needless, self-inflicted mark loss. These are marks you lose without getting anything wrong chemically.
...
The command term is a contract that tells you exactly how much to write. Matching your answer's depth to the verb is one of the cheapest ways to lift a score.
...
The trap is under-answering an "explain" as if it were a "state," and over-writing a "state" into a paragraph that wastes time you need elsewhere. For the full list, read [IB command terms explained](/blog/ib-command-terms-explained).

## The high-frequency calculation types and how to lay them out

A handful of calculation types appear, in some form, on nearly every Paper 2. Drill them until the layout is automatic — the layout is where the method marks live.
...
When the command term is "explain" or "state and explain," the reason carries the mark; the fact alone does not. Compare:
...
None of these are about content. They are about discipline, and removing them lifts the ceiling on your grade.
...
Paper 2 is winnable by method, not luck. It is marked analytically on points, so make your method visible on every line; exploit ECF by never abandoning a calculation; label units and fix your significant figures; decode the command term before you write; and on "explain" questions, give the named reason, not just the fact. Practise full papers with the data booklet open, mark yourself honestly, and Paper 2 stops being a gamble and becomes a set of marks you know how to collect.

...
Run a rough idea through this checklist, tightening each element:

1. Name the **IV** and **DV** explicitly, with **units**, then set a **range** (about five levels) and **repeats** (three or more).
2. List the **controlled variables** you can hold constant, and confirm the plan is **safe and ethical** with your teacher.
3. Write the **theory** you expect to explain the result — if you can't, change the topic.
4. **Pilot** it once, and adjust the range if the equipment can't detect the effect.
...
One that is focused (a single IV and DV), measurable (quantitative data with units), controllable, backed by enough data for analysis, and linked to biology theory you can explain. The *How does X affect Y of Z?* template captures all of this.
...
A strong IB Biology IA starts with a modest, measurable question you can actually run — one IV, one DV, a sensible range, real repeats, and a theory you can explain. Pick an area you find interesting, then refine it until it fits the *How does X affect Y?* template and passes the safety and ethics check. When you're ready, work through the [IB Biology IA guide](/blog/ib-biology-ia-guide).

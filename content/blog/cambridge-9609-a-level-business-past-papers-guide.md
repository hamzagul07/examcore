...
You did not choose Business (9609) because you enjoy reading mark schemes for fun. You chose it because the grade matters — and past papers are where A-Level marks are actually won or lost.

Most students **finish** papers. Fewer students **mark** them properly. This guide is for the second group: you want Cambridge 9609 past papers, real mark scheme language, and a revision loop that moves your grade — not just your page count.

## Who this guide is for

- A-Level students sitting **9609** this series (or planning ahead)
...
- How **9609/XX** papers are labelled and which components you should practise
- What **mixed (case study + essays)** looks like in real examiner language
...
| **Level** | A-Level |
| **Syllabus code** | 9609 |
| **Typical marking** | mixed (case study + essays) |

Past papers are published as **9609/XX** — **XX** is the component number for that session (e.g. Paper 1 vs Paper 4). Download the paper **and** the mark scheme for the **same session** from Cambridge International or your school portal. Mixing sessions is how students practise the right topic with the wrong marking rules.

---

## How Cambridge examines Business
...
## How mark schemes work for Business
...
## Five mistakes that cost marks on 9609
...
### Where do I download 9609 past papers?
...
**9609 rewards precision against the mark scheme**, not vague knowledge. Learn examiner wording, mark honestly once per question, and fix one repeatable error at a time — that is how A-Level Business scores move.

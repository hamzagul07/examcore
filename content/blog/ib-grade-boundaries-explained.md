---
title: IB Grade Boundaries 2026 Explained (May Session)
description: How IB May 2026 grade boundaries work — subject grades 1–7, the 45-point diploma, where to find official thresholds, and why boundaries change each session.
date: 2026-06-19
keywords: IB grade boundaries 2026, IB grade boundaries, IB grading explained, IB May 2026 boundaries, IB 7 points, IB 45 points, how IB grades work
category: revision
author: hassan
updated: 2026-07-06
featured: true
...
The International Baccalaureate grades each subject from **1** (lowest) to **7** (highest). The full Diploma is scored out of **45**. After the **May 2026** exams, official grade boundaries publish with results in **early July** — this guide explains how they work and where to find them.
...
Grade boundaries are the minimum raw marks for each grade (1–7) across assessed components (exams, IA, etc.). Examiners review scripts at grade borders to set fair thresholds — the process is called **awarding**. That is why you cannot aim for a magic "85%" to guarantee a 7.

## The full Diploma score out of 45

Six subjects × 7 = **42 points** maximum. **TOK** and **EE** grades (A–E) combine in a matrix for **0–3 bonus points**. Your Diploma total = subject points + bonus.

## What's the passing score for the IB Diploma?

Minimum **24 points**, plus:
...
See [IB results day 2026](/blog/ib-results-day-2026-what-to-expect) for failing conditions in full.
...
Study **markbands** in official mark schemes alongside [past papers](/ib/past-papers). [Get your work marked](/mark) for band-by-band feedback.

### Do boundaries differ for digital vs paper exams?

The IB equates modes — boundaries apply to the session as a whole. See [digital exams 2026 guide](/blog/ib-digital-exams-2026-student-guide).

## Bottom line

**IB grade boundaries 2026** for the May session publish with results in early July — they keep grades fair across years, not fixed percentages. Read your statement first, fetch official tables through your school, then decide on remarks or retakes using [results day guidance](/blog/ib-results-day-2026-what-to-expect).

...
A **7** is the top grade, and grade boundaries are set each session — historically somewhere around the high-60s to mid-70s percent for the top band, lower than most students fear. That matters, because it means you do **not** need a flawless script. Method marks make maths unusually forgiving: on a typical question you might have three or four marks available, and only the last one depends on the final answer being correct. Miss it and you still keep the rest.

So a 7 is not about never making mistakes. It is about consistently reaching the top of each question's available marks by writing clear, complete method — and adding a strong [exploration (IA)](/blog/ib-maths-ia-guide), which is marked against its own criteria and can lift or sink your overall grade before you sit a single paper.

## How marks work (the most useful thing to understand)
Every AA mark scheme uses the official mathematics conventions. Learn what each label means and you will stop throwing marks away:
...
The two papers reward different muscles, so prepare them differently.
...
The strong candidates treat the calculator as a tool, not a crutch:
...
- **Learn (2–3 sessions).** Take one syllabus subtopic, work through the theory and worked examples in the [Maths AA SL course](/ib/courses/maths-aa-sl) or [HL course](/ib/courses/maths-aa-hl), and build recall with short flashcard bursts.
...
- **Get marked (honest).** Mark against the official scheme, awarding M/A/R marks line by line. Log every dropped mark by *cause* (no working, early rounding, wrong mode) and drill your top three recurring errors next week. When you want a second opinion, [get an answer marked](/mark) for criterion-aligned feedback.

Aim for 6–8 fully marked papers with error logs before exams — quality beats a stack of rushed attempts.
...
## Bottom line
A 7 in Maths AA is engineered, not gifted. Show valid method on every question so method and follow-through marks work for you, keep full precision and round last, respect the Paper 1 / Paper 2 / Paper 3 split, and start your IA early. Cycle learn → timed practice → honest marking each week, and a 7 stops being luck and becomes the predictable result of examiner-shaped habits.

...
Extended answers are judged on **physics reasoning**: clear diagrams, stated assumptions, correct units, and linking maths to physical meaning. A correct number with no working rarely earns full credit.

## A past paper workflow that actually works
Cycle: timed paper → mark → topic drill. Keep a formula sheet you build yourself (not just the booklet). Practise explaining *why* an equation applies, not only *how* to substitute.

## Paper-specific tips
Draw diagrams for forces and circuits. Quote values with **SI units**. For uncertainties, practise combining absolute and percentage errors — a recurring Paper 3 theme.
...
## Bottom line
Treat [IB Physics SL past papers](/ib/past-papers/physics-sl) as training for examiner thinking — not a trivia test. Cycle timed practice, honest band marking, and focused drills on your weakest criteria; that is how top candidates make a 7 predictable rather than lucky.

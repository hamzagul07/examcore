...
Admissions tutors almost always focus on your final grade (e.g., A*, A, B). The underlying percentage uniform mark (PUM) is what determines this grade, but it is not typically a factor in admissions decisions. Their main concern is whether you have met the conditions of their offer, which are expressed in grades. You can [estimate your grade](/tools/grade-boundary-calculator) from practice papers to see how raw marks translate into final grades.
...
## Bottom line
Your Cambridge A Level grades are your passport to universities across the globe, serving as the benchmark for conditional offers. Success depends not only on achieving the grades but also on thoroughly researching the specific requirements of each institution you apply to. Being prepared to act decisively on results day, whether you meet your offer or need to explore other options, is key to a successful transition to higher education. The best way to secure the grades you need is through consistent practice; try to [mark a past paper](/mark) to see where you stand.

---
title: IB Business Management Paper 1 — Pre-Released Case Study Strategy
description: How to prepare for and answer IB Business Management Paper 1: working the pre-released case study, applying theory to the stimulus, hitting AO1–AO3 and the command terms, and structuring the extended response.
date: 2026-07-03
keywords: IB business management paper 1, IB BM pre-released case study, IB business management case study, IB business management paper 1 structure, IB business management application, IB BM exam technique
...
Start the day you receive it. The goal is to know the business so well that any tool you are asked about, you can instantly tie to a detail from the case.
...
Paper 1 is assessed against three **assessment objectives**, not a tally of facts:
...
Some questions include **quantitative elements** drawn from data in the case — a margin, a ratio, a break-even figure. Show your working and always interpret the number back to the business. For the full list, see [IB command terms explained](/blog/ib-command-terms-explained).
...
"Examine," "discuss," "evaluate," "recommend," and "to what extent" questions carry the most marks and are where students stall at one-sided analysis. Full AO3 needs two things.

1. **Balance.** Argue both sides — a benefit *and* a drawback, short term *versus* long term, one stakeholder's gain *against* another's loss, all applied to the case.
2. **A supported judgment.** Do not stop at "it depends." State which side wins *for this business*, and justify it against a clear criterion: the company's objectives, its finances, the timeframe, or the risk it can bear.
...
HL Paper 1 includes a longer **extended-response** question and additional pre-released HL material. Treat it as a mini-essay, not a bloated paragraph:
...
Paper 1 rewards preparation more than any other IB Business Management exam. Learn the pre-released case study until every tool has a detail to attach to, match the command term, apply every point to *this* business, argue both sides, and close "evaluate" questions with a supported judgment. Structure the extended response as a planned mini-essay, show working on any quantitative parts, and [get your answers marked](/mark) against AO1–AO3 until application and judgment are automatic. Do the work before the exam and the paper becomes a formality.

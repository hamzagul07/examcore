...
Describe it as the minimum mark required for a specific grade (e.g., A*, A, B). Explain that Cambridge sets these boundaries *after* all papers are marked to ensure fairness between different exam years. This is why it is impossible to know your exact grade beforehand, even if you [mark a past paper](/mark) and score highly.

## Bottom line
A successful conversation about your Cambridge results hinges on preparation and a forward-looking mindset. By managing expectations beforehand and presenting a clear plan for your next steps, you empower your parents to support you constructively. This transforms a potential moment of judgement into a collaborative planning session focused on your future success.
